	...
	- Paramètres importants pour choisir sa diode TVS
	  id:: 6494b6b2-79bd-4f02-a806-11a13138843c
		...
		- {{youtube-timestamp 323}}
			- Voltage de fonctionnement (*Reverse Working voltage*, $V_{RWM}$)
				- Tension maximale  appliqué à la diode en conditions normales
				- $V_{RWM} \ge V_{signal}$
		- {{youtube-timestamp 356}}
			- Tension maximale (*Clamping voltage*, $V_C$) que va laisser passer la diode sur la ligne protégée
				- Choisir une valeur juste au dessus de la valeur de fonctionnement normal maximale pour éviter de propager des tensions trop importantes
